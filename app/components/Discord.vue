<template>
    <div class="bg-neutral text-neutral-content w-full grid place-items-center">
        <div
            class="flex flex-col md:flex-row items-center md:items-start gap-4 md:gap-20 p-6 lg:p-24 max-w-[1600px]">
            <div>
